...
TransHDM<-function(
  ...
  if(verbose)  message("Estimation of mediator-outcome effects in the outcome model has been completed.")
  ...
  if(verbose) message("Estimation of exposure-mediator effects in the mediator model has been completed.")
